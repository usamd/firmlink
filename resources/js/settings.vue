        ...
        <div class="lg:container mx-auto p-4">
          <div class="grid grid-cols-3 gap-4">
            ...
            <div class="col-span-2 text-right">
              <a href="/user/dashboard/dashboard" class="p-2 pl-0 mr-1 pr-1">
                <button class="bg-green-500 hover:bg-blue-700 text-black font-bold py-2 px-4 rounded">Dashboard</button>
              </a>
              <a href="/chat" class="p-2 pl-0 mr-1 pr-1">
                <button class="bg-green-500 hover:bg-blue-700 text-black font-bold py-2 px-4 rounded">Back</button>
              </a>
            </div>
          </div>
        </div>
